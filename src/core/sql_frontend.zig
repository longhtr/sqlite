...
fn resolveNullBinaryFunctionIndexExpression(token_list: []const Token, position: usize) ?NullBinaryFunctionIndexExpression {
    if (position + 5 >= token_list.len or token_list[position].typ != tokens.tk_id or (!std.ascii.eqlIgnoreCase(token_list[position].text, "ifnull") and !std.ascii.eqlIgnoreCase(token_list[position].text, "coalesce") and !std.ascii.eqlIgnoreCase(token_list[position].text, "nullif") and !std.ascii.eqlIgnoreCase(token_list[position].text, "min") and !std.ascii.eqlIgnoreCase(token_list[position].text, "max") and !std.ascii.eqlIgnoreCase(token_list[position].text, "pow") and !std.ascii.eqlIgnoreCase(token_list[position].text, "power") and !std.ascii.eqlIgnoreCase(token_list[position].text, "mod") and !std.ascii.eqlIgnoreCase(token_list[position].text, "atan2") and !std.ascii.eqlIgnoreCase(token_list[position].text, "log") and !std.ascii.eqlIgnoreCase(token_list[position].text, "round")) or token_list[position + 1].typ != tokens.tk_lp or token_list[position + 3].typ != tokens.tk_comma or token_list[position + 5].typ != tokens.tk_rp) return null;
    ...
    return .{
        ...
        .constant_null = std.ascii.eqlIgnoreCase(token_list[position].text, "min") or std.ascii.eqlIgnoreCase(token_list[position].text, "max") or std.ascii.eqlIgnoreCase(token_list[position].text, "pow") or std.ascii.eqlIgnoreCase(token_list[position].text, "power") or std.ascii.eqlIgnoreCase(token_list[position].text, "mod") or std.ascii.eqlIgnoreCase(token_list[position].text, "atan2") or std.ascii.eqlIgnoreCase(token_list[position].text, "log") or std.ascii.eqlIgnoreCase(token_list[position].text, "round") or (null_first and std.ascii.eqlIgnoreCase(token_list[position].text, "nullif")),
        .consumed = 6,
    };
}
