...
Maintained ADRs record durable fidelity and architecture decisions. ADR-0040 defines the pure-Zig product boundary and supersedes the earlier production C ABI decision. ADR-0041 makes dependency-closed atomic source units, internal traces, prototype retirement, worker containment, and independent review mandatory, and classifies raw scaffold counts as non-progress accounting.
