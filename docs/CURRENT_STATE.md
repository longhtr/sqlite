...
| Historical reviewed-or-later classifications | 2,123 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,872 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 50 |
| Admission-ready dossiers | 50 |
...
| Active batch and durable checkpoints | 7 entries; 0 checkpoints |
