...
| Historical reviewed-or-later classifications | 2,320 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,704 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 152 |
| Admission-ready dossiers | 152 |
...
| Active batch and durable checkpoints | 73 entries; 1 checkpoints |
