...
| Historical reviewed-or-later classifications | 2,171 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,829 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 83 |
| Admission-ready dossiers | 83 |
| Source-translated atomic units | 32 |
...
| Active batch and durable checkpoints | 53 entries; 0 checkpoints |
