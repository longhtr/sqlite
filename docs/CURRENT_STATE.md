...
| Historical reviewed-or-later classifications | 2,138 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,859 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 60 |
| Admission-ready dossiers | 60 |
| Source-translated atomic units | 9 |
...
| Active batch and durable checkpoints | 20 entries; 0 checkpoints |
