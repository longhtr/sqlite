...
| Historical reviewed-or-later classifications | 2,150 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,847 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 70 |
| Admission-ready dossiers | 70 |
| Source-translated atomic units | 19 |
...
| Active batch and durable checkpoints | 32 entries; 0 checkpoints |
