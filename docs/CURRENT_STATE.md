...
| Historical reviewed-or-later classifications | 2,225 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,785 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 111 |
| Admission-ready dossiers | 111 |
| Source-translated atomic units | 61 |
...
| Active batch and durable checkpoints | 109 entries; 0 checkpoints |
