...
| Historical reviewed-or-later classifications | 2,258 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,761 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 128 |
| Admission-ready dossiers | 128 |
| Source-translated atomic units | 78 |
...
| Active batch and durable checkpoints | 15 entries; 1 checkpoints |
