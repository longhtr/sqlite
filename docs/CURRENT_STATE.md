...
| Historical reviewed-or-later classifications | 2,214 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,795 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 104 |
| Admission-ready dossiers | 104 |
| Source-translated atomic units | 54 |
...
| Active batch and durable checkpoints | 98 entries; 0 checkpoints |
