...
| Historical reviewed-or-later classifications | 2,192 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,809 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 99 |
| Admission-ready dossiers | 99 |
| Source-translated atomic units | 48 |
...
| Active batch and durable checkpoints | 74 entries; 0 checkpoints |
