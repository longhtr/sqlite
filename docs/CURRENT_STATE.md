...
| Historical reviewed-or-later classifications | 2,368 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,656 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 172 |
| Admission-ready dossiers | 172 |
| Source-translated atomic units | 121 |
...
| Active batch and durable checkpoints | 118 entries; 1 checkpoints |
