...
| Historical reviewed-or-later classifications | 2,178 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,823 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 88 |
| Admission-ready dossiers | 88 |
| Source-translated atomic units | 37 |
...
| Active batch and durable checkpoints | 60 entries; 0 checkpoints |
