...
| Historical reviewed-or-later classifications | 2,131 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,865 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 57 |
| Admission-ready dossiers | 57 |
| Source-translated atomic units | 6 |
...
| Active batch and durable checkpoints | 13 entries; 0 checkpoints |
