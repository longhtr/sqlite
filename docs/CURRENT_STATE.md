...
| Historical reviewed-or-later classifications | 2,379 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,645 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 181 |
| Admission-ready dossiers | 181 |
| Source-translated atomic units | 130 |
...
| Active batch and durable checkpoints | 112 entries; 1 checkpoints |
