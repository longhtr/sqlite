...
| Historical reviewed-or-later classifications | 2,168 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,829 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 80 |
| Admission-ready dossiers | 80 |
| Source-translated atomic units | 29 |
...
| Active batch and durable checkpoints | 50 entries; 0 checkpoints |
