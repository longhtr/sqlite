...
| Historical reviewed-or-later classifications | 2,221 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,788 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 109 |
| Admission-ready dossiers | 109 |
| Source-translated atomic units | 59 |
...
| Active batch and durable checkpoints | 105 entries; 0 checkpoints |
