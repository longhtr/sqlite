...
| Historical reviewed-or-later classifications | 2,162 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,835 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 76 |
| Admission-ready dossiers | 76 |
| Source-translated atomic units | 25 |
...
| Active batch and durable checkpoints | 44 entries; 0 checkpoints |
