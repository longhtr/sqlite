...
| Historical reviewed-or-later classifications | 2,219 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,790 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 107 |
| Admission-ready dossiers | 107 |
| Source-translated atomic units | 57 |
...
| Active batch and durable checkpoints | 103 entries; 0 checkpoints |
