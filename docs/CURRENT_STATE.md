...
| Historical reviewed-or-later classifications | 2,157 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,840 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 74 |
| Admission-ready dossiers | 74 |
| Source-translated atomic units | 23 |
...
| Active batch and durable checkpoints | 39 entries; 0 checkpoints |
