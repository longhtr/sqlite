...
| Historical reviewed-or-later classifications | 2,165 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,832 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 78 |
| Admission-ready dossiers | 78 |
| Source-translated atomic units | 27 |
...
| Active batch and durable checkpoints | 47 entries; 0 checkpoints |
