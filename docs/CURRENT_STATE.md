...
| Historical reviewed-or-later classifications | 2,238 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,774 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 118 |
| Admission-ready dossiers | 118 |
| Source-translated atomic units | 68 |
...
| Active batch and durable checkpoints | 122 entries; 0 checkpoints |
