...
| Historical reviewed-or-later classifications | 2,226 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,784 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 112 |
| Admission-ready dossiers | 112 |
| Source-translated atomic units | 62 |
...
| Active batch and durable checkpoints | 110 entries; 0 checkpoints |
