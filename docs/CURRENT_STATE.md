...
| Historical reviewed-or-later classifications | 2,122 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,873 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 49 |
| Admission-ready dossiers | 49 |
| Source-translated atomic units | 0 |
| Internal-trace-equivalent atomic units | 30 |
| Subsystem-integrated atomic units | 19 |
| Historical mechanical function claims | 1,738; 0 completion credit |
| Active batch and durable checkpoints | 6 entries; 0 checkpoints |
