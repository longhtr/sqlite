...
| Historical reviewed-or-later classifications | 2,231 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,781 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 114 |
| Admission-ready dossiers | 114 |
| Source-translated atomic units | 64 |
...
| Active batch and durable checkpoints | 115 entries; 0 checkpoints |
