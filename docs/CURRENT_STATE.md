...
| Historical reviewed-or-later classifications | 2,173 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,828 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 85 |
| Admission-ready dossiers | 85 |
| Source-translated atomic units | 34 |
...
| Active batch and durable checkpoints | 55 entries; 0 checkpoints |
