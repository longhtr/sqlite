...
| Historical reviewed-or-later classifications | 2,222 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,788 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 110 |
| Admission-ready dossiers | 110 |
| Source-translated atomic units | 60 |
...
| Active batch and durable checkpoints | 106 entries; 0 checkpoints |
