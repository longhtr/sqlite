...
| Historical reviewed-or-later classifications | 2,289 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,730 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 137 |
| Admission-ready dossiers | 137 |
| Source-translated atomic units | 87 |
...
| Active batch and durable checkpoints | 41 entries; 1 checkpoints |
