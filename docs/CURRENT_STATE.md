...
| Historical reviewed-or-later classifications | 2,136 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,861 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 58 |
| Admission-ready dossiers | 58 |
| Source-translated atomic units | 7 |
...
| Active batch and durable checkpoints | 18 entries; 0 checkpoints |
