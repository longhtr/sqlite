...
| Historical reviewed-or-later classifications | 2,184 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,817 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 94 |
| Admission-ready dossiers | 94 |
| Source-translated atomic units | 43 |
...
| Active batch and durable checkpoints | 66 entries; 0 checkpoints |
