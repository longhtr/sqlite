...
| Historical reviewed-or-later classifications | 2,182 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,819 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 92 |
| Admission-ready dossiers | 92 |
| Source-translated atomic units | 41 |
...
| Active batch and durable checkpoints | 64 entries; 0 checkpoints |
