...
| Historical reviewed-or-later classifications | 2,377 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,647 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 180 |
| Admission-ready dossiers | 180 |
| Source-translated atomic units | 129 |
...
| Active batch and durable checkpoints | 110 entries; 1 checkpoints |
