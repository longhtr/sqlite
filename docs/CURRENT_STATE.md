...
| Historical reviewed-or-later classifications | 2,366 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,658 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 171 |
| Admission-ready dossiers | 171 |
| Source-translated atomic units | 120 |
