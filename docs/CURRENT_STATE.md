...
| Historical reviewed-or-later classifications | 2,345 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,679 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 159 |
| Admission-ready dossiers | 159 |
| Source-translated atomic units | 102 |
...
| Active batch and durable checkpoints | 95 entries; 1 checkpoints |
