...
| Historical reviewed-or-later classifications | 2,169 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,829 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 81 |
| Admission-ready dossiers | 81 |
| Source-translated atomic units | 30 |
...
| Active batch and durable checkpoints | 51 entries; 0 checkpoints |
