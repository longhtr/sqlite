...
| Historical reviewed-or-later classifications | 2,327 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,697 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 155 |
| Admission-ready dossiers | 155 |
...
| Active batch and durable checkpoints | 80 entries; 1 checkpoints |
