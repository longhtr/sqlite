...
| Historical reviewed-or-later classifications | 2,220 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,789 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 108 |
| Admission-ready dossiers | 108 |
| Source-translated atomic units | 58 |
...
| Active batch and durable checkpoints | 104 entries; 0 checkpoints |
