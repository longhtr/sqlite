...
| Historical reviewed-or-later classifications | 2,148 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,849 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 68 |
| Admission-ready dossiers | 68 |
| Source-translated atomic units | 17 |
...
| Active batch and durable checkpoints | 30 entries; 0 checkpoints |
