...
| Historical reviewed-or-later classifications | 2,172 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,829 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 84 |
| Admission-ready dossiers | 84 |
| Source-translated atomic units | 33 |
...
| Active batch and durable checkpoints | 54 entries; 0 checkpoints |
