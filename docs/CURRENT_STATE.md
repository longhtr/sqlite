...
| Historical reviewed-or-later classifications | 2,247 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,772 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 123 |
| Admission-ready dossiers | 123 |
| Source-translated atomic units | 73 |
...
| Active batch and durable checkpoints | 4 entries; 1 checkpoints |
