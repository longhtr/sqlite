...
| Historical reviewed-or-later classifications | 2,326 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,698 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 154 |
| Admission-ready dossiers | 154 |
...
| Active batch and durable checkpoints | 79 entries; 1 checkpoints |
