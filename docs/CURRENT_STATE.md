...
| Historical reviewed-or-later classifications | 2,243 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,772 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 120 |
| Admission-ready dossiers | 120 |
| Source-translated atomic units | 70 |
...
| Active batch and durable checkpoints | 127 entries; 0 checkpoints |
