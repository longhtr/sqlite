...
| Historical reviewed-or-later classifications | 2,156 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,841 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 73 |
| Admission-ready dossiers | 73 |
| Source-translated atomic units | 22 |
...
| Active batch and durable checkpoints | 38 entries; 0 checkpoints |
