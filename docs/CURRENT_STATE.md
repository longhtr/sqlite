...
| Historical reviewed-or-later classifications | 2,324 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,700 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 153 |
| Admission-ready dossiers | 153 |
...
| Active batch and durable checkpoints | 77 entries; 1 checkpoints |
