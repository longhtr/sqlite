...
| Historical reviewed-or-later classifications | 2,160 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,837 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 75 |
| Admission-ready dossiers | 75 |
| Source-translated atomic units | 24 |
...
| Active batch and durable checkpoints | 42 entries; 0 checkpoints |
