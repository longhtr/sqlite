...
| Historical reviewed-or-later classifications | 2,174 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,827 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 86 |
| Admission-ready dossiers | 86 |
| Source-translated atomic units | 35 |
...
| Active batch and durable checkpoints | 56 entries; 0 checkpoints |
