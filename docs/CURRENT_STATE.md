...
| Historical reviewed-or-later classifications | 2,285 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,734 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 135 |
| Admission-ready dossiers | 135 |
| Source-translated atomic units | 85 |
...
| Active batch and durable checkpoints | 37 entries; 1 checkpoints |
