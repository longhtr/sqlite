...
| Historical reviewed-or-later classifications | 2,137 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,860 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 59 |
| Admission-ready dossiers | 59 |
| Source-translated atomic units | 8 |
...
| Active batch and durable checkpoints | 19 entries; 0 checkpoints |
