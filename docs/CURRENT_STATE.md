...
| Historical reviewed-or-later classifications | 2,176 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,825 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 87 |
| Admission-ready dossiers | 87 |
| Source-translated atomic units | 36 |
...
| Active batch and durable checkpoints | 58 entries; 0 checkpoints |
