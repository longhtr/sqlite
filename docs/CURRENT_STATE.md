...
| Historical reviewed-or-later classifications | 2,370 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,654 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 174 |
| Admission-ready dossiers | 174 |
| Source-translated atomic units | 123 |
...
| Active batch and durable checkpoints | 120 entries; 1 checkpoints |
