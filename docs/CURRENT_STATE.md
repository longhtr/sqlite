...
| Historical reviewed-or-later classifications | 2,369 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,655 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 173 |
| Admission-ready dossiers | 173 |
| Source-translated atomic units | 122 |
...
| Active batch and durable checkpoints | 119 entries; 1 checkpoints |
