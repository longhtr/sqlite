...
| Historical reviewed-or-later classifications | 2,170 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,829 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 82 |
| Admission-ready dossiers | 82 |
| Source-translated atomic units | 31 |
...
| Active batch and durable checkpoints | 52 entries; 0 checkpoints |
