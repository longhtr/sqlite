...
| Historical reviewed-or-later classifications | 2,217 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,792 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 105 |
| Admission-ready dossiers | 105 |
| Source-translated atomic units | 55 |
...
| Active batch and durable checkpoints | 101 entries; 0 checkpoints |
