...
| Historical reviewed-or-later classifications | 2,235 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,777 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 117 |
| Admission-ready dossiers | 117 |
| Source-translated atomic units | 67 |
...
| Active batch and durable checkpoints | 119 entries; 0 checkpoints |
