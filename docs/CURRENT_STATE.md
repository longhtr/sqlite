...
| Historical reviewed-or-later classifications | 2,194 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,807 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 100 |
| Admission-ready dossiers | 100 |
| Source-translated atomic units | 49 |
...
| Active batch and durable checkpoints | 76 entries; 0 checkpoints |
