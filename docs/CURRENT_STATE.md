...
| Historical reviewed-or-later classifications | 2,186 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,815 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 95 |
| Admission-ready dossiers | 95 |
| Source-translated atomic units | 44 |
...
| Active batch and durable checkpoints | 68 entries; 0 checkpoints |
