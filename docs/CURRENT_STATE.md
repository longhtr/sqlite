...
| Historical reviewed-or-later classifications | 2,241 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,774 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 119 |
| Admission-ready dossiers | 119 |
| Source-translated atomic units | 69 |
...
| Active batch and durable checkpoints | 125 entries; 0 checkpoints |
