...
| Historical reviewed-or-later classifications | 2,374 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,650 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 178 |
| Admission-ready dossiers | 178 |
| Source-translated atomic units | 127 |
...
| Active batch and durable checkpoints | 124 entries; 1 checkpoints |
