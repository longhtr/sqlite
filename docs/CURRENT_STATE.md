...
| Historical reviewed-or-later classifications | 2,181 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,820 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 91 |
| Admission-ready dossiers | 91 |
| Source-translated atomic units | 40 |
...
| Active batch and durable checkpoints | 63 entries; 0 checkpoints |
