...
| Historical reviewed-or-later classifications | 2,183 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,818 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 93 |
| Admission-ready dossiers | 93 |
| Source-translated atomic units | 42 |
...
| Active batch and durable checkpoints | 65 entries; 0 checkpoints |
