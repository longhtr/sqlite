...
| Historical reviewed-or-later classifications | 2,149 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,848 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 69 |
| Admission-ready dossiers | 69 |
| Source-translated atomic units | 18 |
...
| Active batch and durable checkpoints | 31 entries; 0 checkpoints |
