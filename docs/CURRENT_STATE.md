...
| Historical reviewed-or-later classifications | 2,351 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,673 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 162 |
| Admission-ready dossiers | 162 |
| Source-translated atomic units | 105 |
...
| Active batch and durable checkpoints | 101 entries; 1 checkpoints |
