...
| Historical reviewed-or-later classifications | 2,191 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,810 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 98 |
| Admission-ready dossiers | 98 |
...
| Active batch and durable checkpoints | 73 entries; 0 checkpoints |
