...
| Historical reviewed-or-later classifications | 2,124 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,871 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 51 |
| Admission-ready dossiers | 51 |
| Source-translated atomic units | 1 |
...
| Active batch and durable checkpoints | 8 entries; 0 checkpoints |
