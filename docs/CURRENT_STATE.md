...
| Historical reviewed-or-later classifications | 2,145 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,852 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 67 |
| Admission-ready dossiers | 67 |
| Source-translated atomic units | 16 |
...
| Active batch and durable checkpoints | 27 entries; 0 checkpoints |
