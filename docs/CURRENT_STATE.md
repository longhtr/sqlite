...
| Historical reviewed-or-later classifications | 2,144 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,853 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 66 |
| Admission-ready dossiers | 66 |
...
| Active batch and durable checkpoints | 26 entries; 0 checkpoints |
