...
| Historical reviewed-or-later classifications | 2,143 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,854 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 65 |
| Admission-ready dossiers | 65 |
...
| Active batch and durable checkpoints | 25 entries; 0 checkpoints |
