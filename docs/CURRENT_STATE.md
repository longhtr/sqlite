...
| Historical reviewed-or-later classifications | 2,166 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,831 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 79 |
| Admission-ready dossiers | 79 |
| Source-translated atomic units | 28 |
...
| Active batch and durable checkpoints | 48 entries; 0 checkpoints |
