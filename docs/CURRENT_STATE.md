...
| Process/PCache/VFS/memdb | partial | Shared memdb stores use configured dynamic FAST mutex ownership; main-schema deserialize stages replacement ownership and preserves old content on allocation failure. The process built-in hash has 167 of 178 active name/arity definitions; load-extension, ALTER registration, attached-schema replacement, and broader ownership remain incomplete. |
