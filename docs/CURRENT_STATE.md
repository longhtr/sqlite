...
| Historical reviewed-or-later classifications | 2,218 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,791 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 106 |
| Admission-ready dossiers | 106 |
| Source-translated atomic units | 56 |
...
| Active batch and durable checkpoints | 102 entries; 0 checkpoints |
