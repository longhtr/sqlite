...
| Historical reviewed-or-later classifications | 2,375 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,649 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 179 |
| Admission-ready dossiers | 179 |
| Source-translated atomic units | 128 |
...
| Active batch and durable checkpoints | 125 entries; 1 checkpoints |
