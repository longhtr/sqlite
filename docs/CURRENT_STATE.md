...
| Historical reviewed-or-later classifications | 2,164 |
| Inventoried, unpromoted entities | 0 |
| Unmapped entities | 3,833 |
| Behavioral inventory | 25,930 blocks in 2,457 functions |
| Atomic-unit dossiers total | 77 |
| Admission-ready dossiers | 77 |
| Source-translated atomic units | 26 |
...
| Active batch and durable checkpoints | 46 entries; 0 checkpoints |
