...
int main(void){
  ...
  int reversed_remainder_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_remainder_index ON reversed_arithmetic_data(10%value)",0,0,0);
  int reversed_bitand_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_bitand_index ON reversed_arithmetic_data(10&value)",0,0,0);
