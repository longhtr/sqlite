...
int main(void){
  ...
  int partial_or_enter_conflict_rc=sqlite3_exec(clone,"UPDATE partial_or_data SET marker=12 WHERE id=1",0,0,0);
  int partial_or_delete_rc=sqlite3_exec(clone,"DELETE FROM partial_or_data WHERE id=2",0,0,0);
  int partial_or_enter_rc=sqlite3_exec(clone,"UPDATE partial_or_data SET marker=12 WHERE id=1",0,0,0);
