...
int main(void){
  ...
  printf("partial-explicit-reversed-collation-index\t%d\t%d\t%d\t%d\t%d\t%d\n",partial_explicit_reversed_nocase_index_rc,partial_explicit_reversed_rtrim_index_rc,partial_explicit_literal_nocase_index_rc,partial_explicit_literal_rtrim_index_rc,partial_explicit_literal_is_index_rc,partial_explicit_literal_is_not_index_rc);
