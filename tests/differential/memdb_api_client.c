...
int main(void){
  ...
  printf("substring-expression-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",substring_expression_table_rc,substring_expression_first_rc,substring_expression_index_rc,substring_alias_index_rc,substring_expression_duplicate_rc,substring_expression_second_rc,substring_expression_update_rc,substring_blob_first_rc,substring_blob_duplicate_rc,substring_utf8_first_rc,substring_utf8_duplicate_rc,substring_negative_duplicate_rc,substring_expression_count_rc,(long long)substring_expression_count,substring_expression_reindex_rc,substring_expression_drop_rc);
