...
int main(void){
  ...
  int partial_text_range_ge_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX partial_text_range_ge_index ON partial_text_range_data(value) WHERE status >= 'm'",0,0,0);
  ...
  int partial_text_range_duplicate_rc=sqlite3_exec(clone,"INSERT INTO partial_text_range_data VALUES(3,'zulu',7)",0,0,0);
  ...
  printf("partial-text-range-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",partial_text_range_table_rc,partial_text_range_ge_index_rc,partial_text_range_lt_index_rc,partial_text_range_le_index_rc,partial_text_range_gt_index_rc,partial_text_range_outside_rc,partial_text_range_inside_rc,partial_text_range_duplicate_rc,partial_text_range_enter_conflict_rc,partial_text_range_delete_rc,partial_text_range_enter_rc,partial_text_range_count_rc,(long long)partial_text_range_count,partial_text_range_reindex_rc,partial_text_range_drop_rc);
