...
int main(void){
  ...
  int remainder_expression_index_rc=sqlite3_exec(clone,"CREATE INDEX remainder_expression_index ON multiplicative_expression_data(value%-3.5)",0,0,0);
  ...
  int bitwise_expression_and_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX bitwise_expression_and_index ON bitwise_expression_data(value&1.5)",0,0,0);
  int bitwise_expression_or_index_rc=sqlite3_exec(clone,"CREATE INDEX bitwise_expression_or_index ON bitwise_expression_data(value|-1.5)",0,0,0);
  int bitwise_expression_left_index_rc=sqlite3_exec(clone,"CREATE INDEX bitwise_expression_left_index ON bitwise_expression_data(value<<-1.5)",0,0,0);
  int bitwise_expression_right_index_rc=sqlite3_exec(clone,"CREATE INDEX bitwise_expression_right_index ON bitwise_expression_data(value>>1.5)",0,0,0);
  ...
  int reversed_arithmetic_table_rc=sqlite3_exec(clone,"CREATE TABLE reversed_arithmetic_data(id INTEGER PRIMARY KEY,value INTEGER)",0,0,0);
  int reversed_arithmetic_first_rc=sqlite3_exec(clone,"INSERT INTO reversed_arithmetic_data VALUES(1,2)",0,0,0);
  int reversed_subtract_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX reversed_subtract_index ON reversed_arithmetic_data(10-value)",0,0,0);
  int reversed_add_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_add_index ON reversed_arithmetic_data(10+value)",0,0,0);
  int reversed_multiply_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_multiply_index ON reversed_arithmetic_data(10*value)",0,0,0);
  int reversed_divide_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_divide_index ON reversed_arithmetic_data(10/value)",0,0,0);
  int reversed_remainder_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_remainder_index ON reversed_arithmetic_data(10.5%value)",0,0,0);
  int reversed_bitand_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_bitand_index ON reversed_arithmetic_data(10.5&value)",0,0,0);
  int reversed_bitor_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_bitor_index ON reversed_arithmetic_data(10.5|value)",0,0,0);
  int reversed_left_shift_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_left_shift_index ON reversed_arithmetic_data(10.5<<value)",0,0,0);
  int reversed_right_shift_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_right_shift_index ON reversed_arithmetic_data(10.5>>value)",0,0,0);
  ...
  int reversed_parenthesized_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_parenthesized_index ON reversed_arithmetic_data((10-value))",0,0,0);
  ...
  printf("reversed-arithmetic-boundary\t%d\t%d\t%d\n",reversed_subtract_overflow_index_rc,reversed_parenthesized_index_rc,reversed_arithmetic_negative_rc);
  ...
  int reversed_arithmetic_reindex_rc=sqlite3_exec(clone,"REINDEX reversed_subtract_index",0,0,0);
  int reversed_arithmetic_drop_rc=sqlite3_exec(clone,"DROP TABLE reversed_arithmetic_data",0,0,0);
  printf("reversed-arithmetic-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",reversed_arithmetic_table_rc,reversed_arithmetic_first_rc,reversed_subtract_index_rc,reversed_add_index_rc,reversed_multiply_index_rc,reversed_divide_index_rc,reversed_remainder_index_rc,reversed_bitand_index_rc,reversed_bitor_index_rc,reversed_left_shift_index_rc,reversed_right_shift_index_rc,reversed_arithmetic_duplicate_rc,reversed_arithmetic_second_rc,reversed_arithmetic_zero_rc,reversed_arithmetic_update_rc,reversed_arithmetic_count_rc,(long long)reversed_arithmetic_count,reversed_arithmetic_reindex_rc,reversed_arithmetic_drop_rc);
  int float_arithmetic_table_rc=sqlite3_exec(clone,"CREATE TABLE float_arithmetic_data(id INTEGER PRIMARY KEY,value INTEGER)",0,0,0);
  int float_arithmetic_first_rc=sqlite3_exec(clone,"INSERT INTO float_arithmetic_data VALUES(1,2)",0,0,0);
  int float_add_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX float_add_index ON float_arithmetic_data(value+1.5)",0,0,0);
  int float_subtract_index_rc=sqlite3_exec(clone,"CREATE INDEX float_subtract_index ON float_arithmetic_data(value-1.5)",0,0,0);
  int float_multiply_index_rc=sqlite3_exec(clone,"CREATE INDEX float_multiply_index ON float_arithmetic_data(value*1.5)",0,0,0);
  int float_divide_index_rc=sqlite3_exec(clone,"CREATE INDEX float_divide_index ON float_arithmetic_data(value/1.5)",0,0,0);
  int reversed_float_add_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_add_index ON float_arithmetic_data(1.5+value)",0,0,0);
  int reversed_float_subtract_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_subtract_index ON float_arithmetic_data(1.5-value)",0,0,0);
  int reversed_float_multiply_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_multiply_index ON float_arithmetic_data(1.5*value)",0,0,0);
  int reversed_float_divide_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_divide_index ON float_arithmetic_data(1.5/value)",0,0,0);
  int float_arithmetic_duplicate_rc=sqlite3_exec(clone,"INSERT INTO float_arithmetic_data VALUES(2,2)",0,0,0);
  int float_arithmetic_second_rc=sqlite3_exec(clone,"INSERT INTO float_arithmetic_data VALUES(2,3)",0,0,0);
  int float_arithmetic_zero_rc=sqlite3_exec(clone,"INSERT INTO float_arithmetic_data VALUES(3,0)",0,0,0);
  int float_arithmetic_update_rc=sqlite3_exec(clone,"UPDATE float_arithmetic_data SET value=2 WHERE id=2",0,0,0);
  sqlite3_int64 float_arithmetic_count=-1;
  int float_arithmetic_count_rc=query_value(clone,"SELECT count(*) FROM float_arithmetic_data",&float_arithmetic_count);
  int float_arithmetic_reindex_rc=sqlite3_exec(clone,"REINDEX float_add_index",0,0,0);
  int float_arithmetic_drop_rc=sqlite3_exec(clone,"DROP TABLE float_arithmetic_data",0,0,0);
  printf("float-arithmetic-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",float_arithmetic_table_rc,float_arithmetic_first_rc,float_add_index_rc,float_subtract_index_rc,float_multiply_index_rc,float_divide_index_rc,reversed_float_add_index_rc,reversed_float_subtract_index_rc,reversed_float_multiply_index_rc,reversed_float_divide_index_rc,float_arithmetic_duplicate_rc,float_arithmetic_second_rc,float_arithmetic_zero_rc,float_arithmetic_update_rc,float_arithmetic_count_rc,(long long)float_arithmetic_count,float_arithmetic_reindex_rc,float_arithmetic_drop_rc);
  int real_column_table_rc=sqlite3_exec(clone,"CREATE TABLE real_column_data(id INTEGER PRIMARY KEY,value REAL)",0,0,0);
  int real_column_first_rc=sqlite3_exec(clone,"INSERT INTO real_column_data VALUES(1,1.25)",0,0,0);
  int real_column_abs_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX real_column_abs_index ON real_column_data(abs(value))",0,0,0);
  int real_column_add_index_rc=sqlite3_exec(clone,"CREATE INDEX real_column_add_index ON real_column_data(value+1.5)",0,0,0);
  int real_column_compare_index_rc=sqlite3_exec(clone,"CREATE INDEX real_column_compare_index ON real_column_data(value<2.5)",0,0,0);
  int real_column_between_index_rc=sqlite3_exec(clone,"CREATE INDEX real_column_between_index ON real_column_data(value BETWEEN 1 AND 2.5)",0,0,0);
  int real_column_sqrt_index_rc=sqlite3_exec(clone,"CREATE INDEX real_column_sqrt_index ON real_column_data(sqrt(value))",0,0,0);
  int real_column_min_index_rc=sqlite3_exec(clone,"CREATE INDEX real_column_min_index ON real_column_data(min(value,1.5))",0,0,0);
  int real_column_duplicate_rc=sqlite3_exec(clone,"INSERT INTO real_column_data VALUES(2,1.25)",0,0,0);
  int real_column_second_rc=sqlite3_exec(clone,"INSERT INTO real_column_data VALUES(2,2.25)",0,0,0);
  int real_column_update_rc=sqlite3_exec(clone,"UPDATE real_column_data SET value=1.25 WHERE id=2",0,0,0);
  sqlite3_int64 real_column_count=-1;
  int real_column_count_rc=query_value(clone,"SELECT count(*) FROM real_column_data",&real_column_count);
  int real_column_reindex_rc=sqlite3_exec(clone,"REINDEX real_column_abs_index",0,0,0);
  int real_column_drop_rc=sqlite3_exec(clone,"DROP TABLE real_column_data",0,0,0);
  printf("real-column-expression-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",real_column_table_rc,real_column_first_rc,real_column_abs_index_rc,real_column_add_index_rc,real_column_compare_index_rc,real_column_between_index_rc,real_column_sqrt_index_rc,real_column_min_index_rc,real_column_duplicate_rc,real_column_second_rc,real_column_update_rc,real_column_count_rc,(long long)real_column_count,real_column_reindex_rc,real_column_drop_rc);
  ...
  int float_binary_math_table_rc=sqlite3_exec(clone,"CREATE TABLE float_binary_math_data(id INTEGER PRIMARY KEY,value INTEGER)",0,0,0);
  int float_binary_math_first_rc=sqlite3_exec(clone,"INSERT INTO float_binary_math_data VALUES(1,2)",0,0,0);
  int float_pow_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX float_pow_index ON float_binary_math_data(pow(value,1.5))",0,0,0);
  int reversed_float_power_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_power_index ON float_binary_math_data(power(1.5,value))",0,0,0);
  int float_mod_index_rc=sqlite3_exec(clone,"CREATE INDEX float_mod_index ON float_binary_math_data(mod(value,1.5))",0,0,0);
  int reversed_float_mod_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_mod_index ON float_binary_math_data(mod(5.5,value))",0,0,0);
  int float_atan2_index_rc=sqlite3_exec(clone,"CREATE INDEX float_atan2_index ON float_binary_math_data(atan2(value,-1.5))",0,0,0);
  int float_log_index_rc=sqlite3_exec(clone,"CREATE INDEX float_log_index ON float_binary_math_data(log(1.5,value))",0,0,0);
  int float_binary_math_duplicate_rc=sqlite3_exec(clone,"INSERT INTO float_binary_math_data VALUES(2,2)",0,0,0);
  int float_binary_math_second_rc=sqlite3_exec(clone,"INSERT INTO float_binary_math_data VALUES(2,3)",0,0,0);
  int float_binary_math_update_rc=sqlite3_exec(clone,"UPDATE float_binary_math_data SET value=2 WHERE id=2",0,0,0);
  sqlite3_int64 float_binary_math_count=-1;
  int float_binary_math_count_rc=query_value(clone,"SELECT count(*) FROM float_binary_math_data",&float_binary_math_count);
  int float_binary_math_reindex_rc=sqlite3_exec(clone,"REINDEX float_pow_index",0,0,0);
  int float_binary_math_drop_rc=sqlite3_exec(clone,"DROP TABLE float_binary_math_data",0,0,0);
  printf("float-binary-math-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",float_binary_math_table_rc,float_binary_math_first_rc,float_pow_index_rc,reversed_float_power_index_rc,float_mod_index_rc,reversed_float_mod_index_rc,float_atan2_index_rc,float_log_index_rc,float_binary_math_duplicate_rc,float_binary_math_second_rc,float_binary_math_update_rc,float_binary_math_count_rc,(long long)float_binary_math_count,float_binary_math_reindex_rc,float_binary_math_drop_rc);
  ...
  int null_operator_table_rc=sqlite3_exec(clone,"CREATE TABLE null_operator_data(id INTEGER PRIMARY KEY,value INTEGER)",0,0,0);
  int null_operator_first_rc=sqlite3_exec(clone,"INSERT INTO null_operator_data VALUES(1,2)",0,0,0);
  int null_operator_1_rc=sqlite3_exec(clone,"CREATE INDEX n1 ON null_operator_data(value+NULL)",0,0,0);
  int null_operator_2_rc=sqlite3_exec(clone,"CREATE INDEX n2 ON null_operator_data(NULL-value)",0,0,0);
  int null_operator_3_rc=sqlite3_exec(clone,"CREATE INDEX n3 ON null_operator_data(value*NULL)",0,0,0);
  int null_operator_4_rc=sqlite3_exec(clone,"CREATE INDEX n4 ON null_operator_data(NULL/value)",0,0,0);
  int null_operator_5_rc=sqlite3_exec(clone,"CREATE INDEX n5 ON null_operator_data(value%NULL)",0,0,0);
  int null_operator_6_rc=sqlite3_exec(clone,"CREATE INDEX n6 ON null_operator_data(value&NULL)",0,0,0);
  int null_operator_7_rc=sqlite3_exec(clone,"CREATE INDEX n7 ON null_operator_data(NULL|value)",0,0,0);
  int null_operator_8_rc=sqlite3_exec(clone,"CREATE INDEX n8 ON null_operator_data(value<<NULL)",0,0,0);
  int null_operator_9_rc=sqlite3_exec(clone,"CREATE INDEX n9 ON null_operator_data(NULL>>value)",0,0,0);
  int null_operator_10_rc=sqlite3_exec(clone,"CREATE INDEX n10 ON null_operator_data(value=NULL)",0,0,0);
  int null_operator_11_rc=sqlite3_exec(clone,"CREATE INDEX n11 ON null_operator_data(NULL!=value)",0,0,0);
  int null_operator_12_rc=sqlite3_exec(clone,"CREATE INDEX n12 ON null_operator_data(value<NULL)",0,0,0);
  int null_operator_13_rc=sqlite3_exec(clone,"CREATE INDEX n13 ON null_operator_data(NULL<=value)",0,0,0);
  int null_operator_14_rc=sqlite3_exec(clone,"CREATE INDEX n14 ON null_operator_data(value>NULL)",0,0,0);
  int null_operator_15_rc=sqlite3_exec(clone,"CREATE INDEX n15 ON null_operator_data(NULL>=value)",0,0,0);
  printf("null-operator-index-create\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",null_operator_1_rc,null_operator_2_rc,null_operator_3_rc,null_operator_4_rc,null_operator_5_rc,null_operator_6_rc,null_operator_7_rc,null_operator_8_rc,null_operator_9_rc,null_operator_10_rc,null_operator_11_rc,null_operator_12_rc,null_operator_13_rc,null_operator_14_rc,null_operator_15_rc);
  int null_operator_second_rc=sqlite3_exec(clone,"INSERT INTO null_operator_data VALUES(2,3)",0,0,0);
  int null_operator_update_rc=sqlite3_exec(clone,"UPDATE null_operator_data SET value=4 WHERE id=2",0,0,0);
  sqlite3_int64 null_operator_count=-1;
  int null_operator_count_rc=query_value(clone,"SELECT count(*) FROM null_operator_data",&null_operator_count);
  int null_operator_reindex_rc=sqlite3_exec(clone,"REINDEX n1",0,0,0);
  int null_operator_drop_rc=sqlite3_exec(clone,"DROP TABLE null_operator_data",0,0,0);
  printf("null-operator-index\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",null_operator_table_rc,null_operator_first_rc,null_operator_second_rc,null_operator_update_rc,null_operator_count_rc,(long long)null_operator_count,null_operator_reindex_rc,null_operator_drop_rc);
  ...
  int reversed_nullif_table_rc=sqlite3_exec(clone,"CREATE TABLE reversed_nullif_data(id INTEGER PRIMARY KEY,value INTEGER)",0,0,0);
  int reversed_nullif_first_rc=sqlite3_exec(clone,"INSERT INTO reversed_nullif_data VALUES(1,NULL)",0,0,0);
  ...
  int reversed_nullif_update_rc=sqlite3_exec(clone,"UPDATE reversed_nullif_data SET value=NULL WHERE id=2",0,0,0);
  sqlite3_int64 reversed_nullif_count=-1;
  int reversed_nullif_count_rc=query_value(clone,"SELECT count(*) FROM reversed_nullif_data",&reversed_nullif_count);
  int reversed_nullif_reindex_rc=sqlite3_exec(clone,"REINDEX reversed_nullif_index",0,0,0);
  int reversed_nullif_drop_rc=sqlite3_exec(clone,"DROP TABLE reversed_nullif_data",0,0,0);
  printf("reversed-nullif-expression-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",reversed_nullif_table_rc,reversed_nullif_first_rc,reversed_nullif_index_rc,reversed_ifnull_index_rc,reversed_coalesce_index_rc,reversed_nullif_equal_rc,reversed_nullif_duplicate_rc,reversed_nullif_other_duplicate_rc,reversed_nullif_update_rc,reversed_nullif_count_rc,(long long)reversed_nullif_count,reversed_nullif_reindex_rc,reversed_nullif_drop_rc);
  int null_argument_table_rc=sqlite3_exec(clone,"CREATE TABLE null_argument_data(id INTEGER PRIMARY KEY,value INTEGER)",0,0,0);
  int null_argument_first_rc=sqlite3_exec(clone,"INSERT INTO null_argument_data VALUES(1,1)",0,0,0);
  int null_argument_ifnull_first_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX null_argument_ifnull_first_index ON null_argument_data(ifnull(NULL,value))",0,0,0);
  int null_argument_ifnull_second_index_rc=sqlite3_exec(clone,"CREATE INDEX null_argument_ifnull_second_index ON null_argument_data(ifnull(value,NULL))",0,0,0);
  int null_argument_coalesce_index_rc=sqlite3_exec(clone,"CREATE INDEX null_argument_coalesce_index ON null_argument_data(coalesce(NULL,value))",0,0,0);
  int null_argument_nullif_first_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX null_argument_nullif_first_index ON null_argument_data(nullif(NULL,value))",0,0,0);
  int null_argument_nullif_second_index_rc=sqlite3_exec(clone,"CREATE INDEX null_argument_nullif_second_index ON null_argument_data(nullif(value,NULL))",0,0,0);
  int null_argument_duplicate_rc=sqlite3_exec(clone,"INSERT INTO null_argument_data VALUES(2,1)",0,0,0);
  int null_argument_second_rc=sqlite3_exec(clone,"INSERT INTO null_argument_data VALUES(2,2)",0,0,0);
  int null_argument_null_rc=sqlite3_exec(clone,"INSERT INTO null_argument_data VALUES(3,NULL)",0,0,0);
  int null_argument_update_rc=sqlite3_exec(clone,"UPDATE null_argument_data SET value=1 WHERE id=2",0,0,0);
  sqlite3_int64 null_argument_count=-1;
  int null_argument_count_rc=query_value(clone,"SELECT count(*) FROM null_argument_data",&null_argument_count);
  int null_argument_reindex_rc=sqlite3_exec(clone,"REINDEX null_argument_ifnull_first_index",0,0,0);
  int null_argument_drop_rc=sqlite3_exec(clone,"DROP TABLE null_argument_data",0,0,0);
  printf("null-argument-expression-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",null_argument_table_rc,null_argument_first_rc,null_argument_ifnull_first_index_rc,null_argument_ifnull_second_index_rc,null_argument_coalesce_index_rc,null_argument_nullif_first_index_rc,null_argument_nullif_second_index_rc,null_argument_duplicate_rc,null_argument_second_rc,null_argument_null_rc,null_argument_update_rc,null_argument_count_rc,(long long)null_argument_count,null_argument_reindex_rc,null_argument_drop_rc);
  ...
  int float_minmax_table_rc=sqlite3_exec(clone,"CREATE TABLE float_minmax_data(id INTEGER PRIMARY KEY,value INTEGER)",0,0,0);
  int float_minmax_first_rc=sqlite3_exec(clone,"INSERT INTO float_minmax_data VALUES(1,1)",0,0,0);
  int float_min_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX float_min_index ON float_minmax_data(min(value,1.5))",0,0,0);
  int float_max_index_rc=sqlite3_exec(clone,"CREATE INDEX float_max_index ON float_minmax_data(max(value,1.5))",0,0,0);
  int reversed_float_min_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_min_index ON float_minmax_data(min(-1.5,value))",0,0,0);
  int reversed_float_max_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_max_index ON float_minmax_data(max(-1.5,value))",0,0,0);
  int float_minmax_duplicate_rc=sqlite3_exec(clone,"INSERT INTO float_minmax_data VALUES(2,1)",0,0,0);
  int float_minmax_second_rc=sqlite3_exec(clone,"INSERT INTO float_minmax_data VALUES(2,2)",0,0,0);
  int float_minmax_update_rc=sqlite3_exec(clone,"UPDATE float_minmax_data SET value=1 WHERE id=2",0,0,0);
  sqlite3_int64 float_minmax_count=-1;
  int float_minmax_count_rc=query_value(clone,"SELECT count(*) FROM float_minmax_data",&float_minmax_count);
  int float_minmax_reindex_rc=sqlite3_exec(clone,"REINDEX float_min_index",0,0,0);
  int float_minmax_drop_rc=sqlite3_exec(clone,"DROP TABLE float_minmax_data",0,0,0);
  printf("float-minmax-expression-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",float_minmax_table_rc,float_minmax_first_rc,float_min_index_rc,float_max_index_rc,reversed_float_min_index_rc,reversed_float_max_index_rc,float_minmax_duplicate_rc,float_minmax_second_rc,float_minmax_update_rc,float_minmax_count_rc,(long long)float_minmax_count,float_minmax_reindex_rc,float_minmax_drop_rc);
  ...
  int float_range_expression_table_rc=sqlite3_exec(clone,"CREATE TABLE float_range_expression_data(id INTEGER PRIMARY KEY,value INTEGER)",0,0,0);
  int float_range_expression_first_rc=sqlite3_exec(clone,"INSERT INTO float_range_expression_data VALUES(1,5)",0,0,0);
  int float_between_expression_index_rc=sqlite3_exec(clone,"CREATE INDEX float_between_expression_index ON float_range_expression_data(value BETWEEN -1.5 AND 10.5)",0,0,0);
  ...
  int float_range_expression_count_rc=query_value(clone,"SELECT count(*) FROM float_range_expression_data",&float_range_expression_count);
  int float_range_expression_reindex_rc=sqlite3_exec(clone,"REINDEX float_between_expression_index",0,0,0);
  int float_range_expression_drop_rc=sqlite3_exec(clone,"DROP TABLE float_range_expression_data",0,0,0);
  printf("float-range-expression-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",float_range_expression_table_rc,float_range_expression_first_rc,float_between_expression_index_rc,float_not_between_expression_index_rc,float_in_expression_index_rc,float_not_in_expression_index_rc,float_range_expression_second_rc,float_range_expression_update_rc,float_range_expression_count_rc,(long long)float_range_expression_count,float_range_expression_reindex_rc,float_range_expression_drop_rc);
  ...
  int float_is_expression_index_rc=sqlite3_exec(clone,"CREATE INDEX float_is_expression_index ON is_expression_data(value IS 1.5)",0,0,0);
  int float_is_not_expression_index_rc=sqlite3_exec(clone,"CREATE INDEX float_is_not_expression_index ON is_expression_data(value IS NOT -1.5)",0,0,0);
  int reversed_float_is_expression_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_is_expression_index ON is_expression_data(1.5 IS value)",0,0,0);
  int reversed_float_distinct_expression_index_rc=sqlite3_exec(clone,"CREATE INDEX reversed_float_distinct_expression_index ON is_expression_data(-1.5 IS DISTINCT FROM value)",0,0,0);
  printf("reversed-is-expression-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",reversed_is_expression_index_rc,reversed_is_distinct_expression_index_rc,reversed_is_not_distinct_expression_index_rc,float_is_expression_index_rc,float_is_not_expression_index_rc,reversed_float_is_expression_index_rc,reversed_float_distinct_expression_index_rc);
  ...
  int pattern_expression_count_rc=query_value(clone,"SELECT count(*) FROM pattern_expression_data",&pattern_expression_count);
  ...
  int partial_isnull_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_isnull_index ON partial_null_data(value) WHERE marker ISNULL",0,0,0);
  int partial_notnull_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_notnull_index ON partial_null_data(value) WHERE marker NOTNULL",0,0,0);
  printf("partial-null-reversed-index\t%d\t%d\t%d\t%d\t%d\t%d\n",partial_null_reversed_index_rc,partial_not_null_reversed_index_rc,partial_null_distinct_index_rc,partial_null_not_distinct_index_rc,partial_isnull_index_rc,partial_notnull_index_rc);
  ...
  int partial_constant_table_rc=sqlite3_exec(clone,"CREATE TABLE partial_constant_data(id INTEGER PRIMARY KEY,value INTEGER)",0,0,0);
  int partial_true_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX partial_true_index ON partial_constant_data(value) WHERE 1",0,0,0);
  int partial_false_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_false_index ON partial_constant_data(value) WHERE 0",0,0,0);
  int partial_null_constant_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_null_constant_index ON partial_constant_data(value) WHERE NULL",0,0,0);
  ...
  int partial_null_or_true_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_null_or_true_index ON partial_constant_data(value) WHERE NULL OR 1",0,0,0);
  int partial_null_or_false_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_null_or_false_index ON partial_constant_data(value) WHERE NULL OR 0",0,0,0);
  int partial_null_and_true_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_null_and_true_index ON partial_constant_data(value) WHERE NULL AND 1",0,0,0);
  int partial_null_and_false_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_null_and_false_index ON partial_constant_data(value) WHERE NULL AND 0",0,0,0);
  printf("partial-float-constant-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",partial_float_false_index_rc,partial_float_true_index_rc,partial_not_null_constant_index_rc,partial_column_null_comparison_index_rc,partial_null_column_comparison_index_rc,partial_null_or_true_index_rc,partial_null_or_false_index_rc,partial_null_and_true_index_rc,partial_null_and_false_index_rc);
  ...
  int partial_constant_update_rc=sqlite3_exec(clone,"UPDATE partial_constant_data SET value=7 WHERE id=2",0,0,0);
  sqlite3_int64 partial_constant_count=-1;
  int partial_constant_count_rc=query_value(clone,"SELECT count(*) FROM partial_constant_data",&partial_constant_count);
  int partial_constant_reindex_rc=sqlite3_exec(clone,"REINDEX partial_true_index",0,0,0);
  int partial_constant_drop_rc=sqlite3_exec(clone,"DROP TABLE partial_constant_data",0,0,0);
  printf("partial-constant-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",partial_constant_table_rc,partial_true_index_rc,partial_false_index_rc,partial_null_constant_index_rc,partial_not_false_index_rc,partial_constant_first_rc,partial_constant_duplicate_rc,partial_constant_second_rc,partial_constant_update_rc,partial_constant_count_rc,(long long)partial_constant_count,partial_constant_reindex_rc,partial_constant_drop_rc);
  ...
  int partial_float_table_rc=sqlite3_exec(clone,"CREATE TABLE partial_float_data(id INTEGER PRIMARY KEY,marker DECIMAL,value INTEGER)",0,0,0);
  ...
  int partial_float_enter_conflict_rc=sqlite3_exec(clone,"UPDATE partial_float_data SET marker=2 WHERE id=1",0,0,0);
  int partial_float_delete_rc=sqlite3_exec(clone,"DELETE FROM partial_float_data WHERE id=2",0,0,0);
  int partial_float_enter_rc=sqlite3_exec(clone,"UPDATE partial_float_data SET marker=2 WHERE id=1",0,0,0);
  sqlite3_int64 partial_float_predicate_count=-1;
  int partial_float_count_rc=query_value(clone,"SELECT count(*) FROM partial_float_data",&partial_float_predicate_count);
  int partial_float_reindex_rc=sqlite3_exec(clone,"REINDEX partial_float_index",0,0,0);
  int partial_float_drop_rc=sqlite3_exec(clone,"DROP TABLE partial_float_data",0,0,0);
  printf("partial-float-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",partial_float_table_rc,partial_float_index_rc,partial_float_reverse_index_rc,partial_float_eq_index_rc,partial_float_ne_index_rc,partial_float_le_index_rc,partial_float_ge_reverse_index_rc,partial_float_outside_rc,partial_float_inside_rc,partial_float_duplicate_rc,partial_float_enter_conflict_rc,partial_float_delete_rc,partial_float_enter_rc,partial_float_count_rc,(long long)partial_float_predicate_count,partial_float_reindex_rc,partial_float_drop_rc);
  ...
  int partial_glob_function_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_glob_function_index ON partial_like_data(value) WHERE glob('[d-f]*',marker)",0,0,0);
  int partial_not_glob_function_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_not_glob_function_index ON partial_like_data(value) WHERE NOT glob('z*',marker)",0,0,0);
  printf("partial-like-function-index\t%d\t%d\t%d\t%d\t%d\n",partial_like_function_index_rc,partial_not_like_function_index_rc,partial_like_function_escape_index_rc,partial_glob_function_index_rc,partial_not_glob_function_index_rc);
  ...
  int partial_like_enter_rc=sqlite3_exec(clone,"UPDATE partial_like_data SET marker='atom' WHERE id=1",0,0,0);
  sqlite3_int64 partial_like_count=-1;
  int partial_like_count_rc=query_value(clone,"SELECT count(*) FROM partial_like_data",&partial_like_count);
  int partial_like_reindex_rc=sqlite3_exec(clone,"REINDEX partial_like_index",0,0,0);
  int partial_like_drop_rc=sqlite3_exec(clone,"DROP TABLE partial_like_data",0,0,0);
  printf("partial-like-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",partial_like_table_rc,partial_like_index_rc,partial_not_like_index_rc,partial_like_outside_rc,partial_like_inside_rc,partial_like_duplicate_rc,partial_like_enter_conflict_rc,partial_like_delete_rc,partial_like_enter_rc,partial_like_count_rc,(long long)partial_like_count,partial_like_reindex_rc,partial_like_drop_rc);
  int partial_integer_like_table_rc=sqlite3_exec(clone,"CREATE TABLE partial_integer_like_data(id INTEGER PRIMARY KEY,marker INTEGER,value INTEGER)",0,0,0);
  int partial_integer_like_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX partial_integer_like_index ON partial_integer_like_data(value) WHERE marker LIKE '1%'",0,0,0);
  int partial_integer_glob_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_integer_glob_index ON partial_integer_like_data(value) WHERE glob('2*',marker)",0,0,0);
  int partial_integer_like_outside_rc=sqlite3_exec(clone,"INSERT INTO partial_integer_like_data VALUES(1,20,7)",0,0,0);
  int partial_integer_like_inside_rc=sqlite3_exec(clone,"INSERT INTO partial_integer_like_data VALUES(2,12,7)",0,0,0);
  int partial_integer_like_duplicate_rc=sqlite3_exec(clone,"INSERT INTO partial_integer_like_data VALUES(3,13,7)",0,0,0);
  int partial_integer_like_enter_conflict_rc=sqlite3_exec(clone,"UPDATE partial_integer_like_data SET marker=14 WHERE id=1",0,0,0);
  int partial_integer_like_delete_rc=sqlite3_exec(clone,"DELETE FROM partial_integer_like_data WHERE id=2",0,0,0);
  int partial_integer_like_enter_rc=sqlite3_exec(clone,"UPDATE partial_integer_like_data SET marker=14 WHERE id=1",0,0,0);
  sqlite3_int64 partial_integer_like_count=-1;
  int partial_integer_like_count_rc=query_value(clone,"SELECT count(*) FROM partial_integer_like_data",&partial_integer_like_count);
  int partial_integer_like_reindex_rc=sqlite3_exec(clone,"REINDEX partial_integer_like_index",0,0,0);
  int partial_integer_like_drop_rc=sqlite3_exec(clone,"DROP TABLE partial_integer_like_data",0,0,0);
  printf("partial-integer-like-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",partial_integer_like_table_rc,partial_integer_like_index_rc,partial_integer_glob_index_rc,partial_integer_like_outside_rc,partial_integer_like_inside_rc,partial_integer_like_duplicate_rc,partial_integer_like_enter_conflict_rc,partial_integer_like_delete_rc,partial_integer_like_enter_rc,partial_integer_like_count_rc,(long long)partial_integer_like_count,partial_integer_like_reindex_rc,partial_integer_like_drop_rc);
  ...
  int partial_explicit_literal_is_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_explicit_literal_is_index ON partial_explicit_collation_data(value) WHERE status IS 'active' COLLATE NOCASE",0,0,0);
  int partial_explicit_literal_is_not_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_explicit_literal_is_not_index ON partial_explicit_collation_data(value) WHERE status IS NOT 'ready' COLLATE RTRIM",0,0,0);
  int partial_explicit_leading_literal_nocase_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_explicit_leading_literal_nocase_index ON partial_explicit_collation_data(value) WHERE 'active' COLLATE NOCASE=status",0,0,0);
  int partial_explicit_leading_literal_rtrim_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_explicit_leading_literal_rtrim_index ON partial_explicit_collation_data(value) WHERE 'ready' COLLATE RTRIM IS status",0,0,0);
  printf("partial-explicit-reversed-collation-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",partial_explicit_reversed_nocase_index_rc,partial_explicit_reversed_rtrim_index_rc,partial_explicit_literal_nocase_index_rc,partial_explicit_literal_rtrim_index_rc,partial_explicit_literal_is_index_rc,partial_explicit_literal_is_not_index_rc,partial_explicit_leading_literal_nocase_index_rc,partial_explicit_leading_literal_rtrim_index_rc);
  ...
  int partial_explicit_rtrim_inside_rc=sqlite3_exec(clone,"INSERT INTO partial_explicit_collation_data VALUES(3,'ready   ',8)",0,0,0);
  int partial_explicit_rtrim_duplicate_rc=sqlite3_exec(clone,"INSERT INTO partial_explicit_collation_data VALUES(4,'ready',8)",0,0,0);
  int partial_explicit_enter_conflict_rc=sqlite3_exec(clone,"UPDATE partial_explicit_collation_data SET status='ACTIVE' WHERE id=1",0,0,0);
  int partial_explicit_delete_rc=sqlite3_exec(clone,"DELETE FROM partial_explicit_collation_data WHERE id=2",0,0,0);
  int partial_explicit_enter_rc=sqlite3_exec(clone,"UPDATE partial_explicit_collation_data SET status='ACTIVE' WHERE id=1",0,0,0);
  sqlite3_int64 partial_explicit_collation_count=-1;
  int partial_explicit_collation_count_rc=query_value(clone,"SELECT count(*) FROM partial_explicit_collation_data",&partial_explicit_collation_count);
  ...
  int partial_collation_literal_first_is_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_collation_literal_first_is_index ON partial_collation_precedence_data(value) WHERE 'active' COLLATE NOCASE IS status COLLATE BINARY",0,0,0);
  int partial_collation_column_first_is_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_collation_column_first_is_index ON partial_collation_precedence_data(value) WHERE status COLLATE BINARY IS 'active' COLLATE NOCASE",0,0,0);
  ...
  printf("partial-collation-precedence-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",partial_collation_precedence_table_rc,partial_collation_literal_first_index_rc,partial_collation_column_first_index_rc,partial_collation_literal_first_is_index_rc,partial_collation_column_first_is_index_rc,partial_collation_precedence_first_rc,partial_collation_precedence_duplicate_rc,partial_collation_precedence_exact_rc,partial_collation_precedence_count_rc,(long long)partial_collation_precedence_count,partial_collation_precedence_reindex_rc,partial_collation_precedence_drop_rc);
  ...
  int partial_not_comparison_table_rc=sqlite3_exec(clone,"CREATE TABLE partial_not_comparison_data(id INTEGER PRIMARY KEY,value INTEGER,a INTEGER)",0,0,0);
  int partial_not_comparison_index_rc=sqlite3_exec(clone,"CREATE UNIQUE INDEX partial_not_comparison_index ON partial_not_comparison_data(value) WHERE NOT a=1",0,0,0);
  int partial_double_not_index_rc=sqlite3_exec(clone,"CREATE INDEX partial_double_not_index ON partial_not_comparison_data(value) WHERE NOT NOT (a=1)",0,0,0);
  int partial_not_comparison_outside_rc=sqlite3_exec(clone,"INSERT INTO partial_not_comparison_data VALUES(1,20,1)",0,0,0);
  int partial_not_comparison_inside_rc=sqlite3_exec(clone,"INSERT INTO partial_not_comparison_data VALUES(2,20,0)",0,0,0);
  int partial_not_comparison_duplicate_rc=sqlite3_exec(clone,"INSERT INTO partial_not_comparison_data VALUES(3,20,0)",0,0,0);
  ...
  int partial_not_comparison_drop_rc=sqlite3_exec(clone,"DROP TABLE partial_not_comparison_data",0,0,0);
  printf("partial-not-comparison-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",partial_not_comparison_table_rc,partial_not_comparison_index_rc,partial_double_not_index_rc,partial_not_comparison_outside_rc,partial_not_comparison_inside_rc,partial_not_comparison_duplicate_rc,partial_not_comparison_enter_rc,partial_not_comparison_delete_rc,partial_not_comparison_enter_after_delete_rc,partial_not_comparison_count_rc,(long long)partial_not_comparison_count,partial_not_comparison_reindex_rc,partial_not_comparison_drop_rc);
  ...
  int partial_reversed_text_inside_rc=sqlite3_exec(clone,"INSERT INTO partial_reversed_data VALUES(3,30,1,'z')",0,0,0);
  int partial_reversed_text_duplicate_rc=sqlite3_exec(clone,"INSERT INTO partial_reversed_data VALUES(4,30,1,'y')",0,0,0);
  ...
  int partial_reversed_drop_rc=sqlite3_exec(clone,"DROP TABLE partial_reversed_data",0,0,0);
  printf("partial-reversed-index\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%d\t%lld\t%d\t%d\n",partial_reversed_table_rc,partial_reversed_integer_index_rc,partial_reversed_text_index_rc,partial_reversed_outside_rc,partial_reversed_integer_inside_rc,partial_reversed_integer_duplicate_rc,partial_reversed_text_inside_rc,partial_reversed_text_duplicate_rc,partial_reversed_enter_conflict_rc,partial_reversed_delete_rc,partial_reversed_enter_rc,partial_reversed_count_rc,(long long)partial_reversed_count,partial_reversed_reindex_rc,partial_reversed_drop_rc);
